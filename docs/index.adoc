...
A2L description files and other files needed for XCP support are placed in `/extra/org.fmi-standard.fmi-ls-xcp`, so they can be modified after the FMU has been created.
