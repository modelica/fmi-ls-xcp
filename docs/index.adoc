...
_<<XCP-Communication-via-V-ECU-COM-Stack>> shows an alternative design where the XCP slave communicates via the virtual ECU's COM stack as in a real ECU._
...
.Communication of XCP master and XCP slave via virtual ECU's COM stack
