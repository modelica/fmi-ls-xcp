...
A2L description files and other files needed for XCP support will be placed in the `extra` directory under the reverse domain name controlled by the MAP FMI: `/extra/org.modelica.fmi-ls-xcp`.
