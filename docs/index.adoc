...
#ToDo# Fix image "IP stack of the host OS" -> "XCP slave communicates via COM stack of virtual ECU"
...
#ToDo# Are XCP Events from the FMU limitated or not? Is it described well enough to say it is "specified"?
