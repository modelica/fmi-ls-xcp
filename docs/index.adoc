...
_[For instance is time not necessarily equidistant and not necessarily monotonically increasing in Model Exchange, and Intermediate Variable Access might also introduce surprising effects in Co-Simulation._
_This means that some kind of buffering is necessary._
